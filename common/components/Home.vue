<template>
    <BasePage id="home" showMenuIcon @navigatedTo="onNavigatedTo">
        ...
        <GridLayout backgroundColor="white" elevation="10" borderRadius="25" margin="0 40 50 40" v-show="!currentlyLoggedIn" verticalAlignment="bottom">
            <StackLayout>
