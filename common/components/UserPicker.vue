<template>
    ...
    <BasePage showMenuIcon modal actionBarThemed :title="title">
        ...
        <GridLayout class="pageContent" rows="auto,auto,8,*">
            <GridLayout columns="auto,*,auto" height="50" margin="10 16 10 16" borderRadius="25" borderWidth="1" borderColor="#F2F2F2" padding="0 10 0 10">
                ...
                <TextField
                    ...
                    @loaded="onTFLoaded"
                />
                <Button col="2" variant="text" class="icon-btn" text="mdi-qrcode-scan" />
            </GridLayout>
            <TabsBar
                row="1"
                :height="40"
            ...
            <CollectionView row="3" rowHeight="70" :items="filteredDataItems">
                <v-template>
                    <GridLayout columns="30,60,*" @tap="chooseRecipient(item)" :rippleColor="colorPrimary">
                        ...
                        <StackLayout col="2" verticalAlignment="center">
                            ...
                            <Label :fontSize="14 * sizeFactor" :text="item | address" :color="subtitleColor" :maxLines="1" lineBreak="end" />
                        </StackLayout>
                        <AbsoluteLayout col="2" verticalAlignment="bottom" backgroundColor="#ECECEC" height="1" />
                    </GridLayout>
                </v-template>
            </CollectionView>
        </GridLayout>
